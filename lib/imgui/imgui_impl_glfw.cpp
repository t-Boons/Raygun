...
static int ImGui_ImplGlfw_TranslateUntranslatedKey(int key, int scancode)
{
    ...
    // (It had reasons to do so: namely GLFW is/was more likely to be used for WASD-type 
    // 
    //  controls rather than lettered shortcuts, but IHMO the 3.1 change could have been done differently)
