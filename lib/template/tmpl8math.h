...
struct ALIGN( 8 ) uint2
{
	...
	uint2( const uint32_t a ) : x( a ), y( a ) {}
...
{
	uint4() = default;
	uint4( const uint32_t a, const uint32_t b, const uint32_t c, const uint32_t d ) : x( a ), y( b ), z( c ), w( d ) {}
	uint4( const uint32_t a ) : x( a ), y( a ), z( a ), w( a ) {}
	uint4( const uint3 & a, const uint32_t d );
...
{
	uint3() = default;
	uint3( const uint32_t a, const uint32_t b, const uint32_t c ) : x( a ), y( b ), z( c ) {}
	uint3( const uint32_t a ) : x( a ), y( a ), z( a ) {}
	uint3( const uint4 a ) : x( a.x ), y( a.y ), z( a.z ) {}
	union { struct { uint32_t x, y, z; uint32_t dummy; }; uint32_t cell[4]; };
	uint32_t& operator [] ( const int n ) { return cell[n]; }
};
struct float3;
...
// random numbers
uint32_t InitSeed( uint32_t seedBase );
uint32_t RandomUInt();
...
inline uint2 make_uint2( const uint32_t a, const uint32_t b ) { uint2 u2; u2.x = a, u2.y = b; return u2; }
inline uint2 make_uint2( const uint32_t s ) { return make_uint2( s, s ); }
inline uint2 make_uint2( const uint3& a ) { return make_uint2( a.x, a.y ); }
inline uint2 make_uint2( const int2& a ) { return make_uint2( uint32_t( a.x ), uint32_t( a.y ) ); }
...
inline uint3 make_uint3( const uint32_t a, uint32_t b, uint32_t c ) { uint3 u3; u3.x = a, u3.y = b, u3.z = c; return u3; }
inline uint3 make_uint3( const uint32_t s ) { return make_uint3( s, s, s ); }
inline uint3 make_uint3( const uint2& a ) { return make_uint3( a.x, a.y, 0 ); }
inline uint3 make_uint3( const uint2& a, const uint32_t s ) { return make_uint3( a.x, a.y, s ); }
inline uint3 make_uint3( const uint4& a ) { return make_uint3( a.x, a.y, a.z ); }
inline uint3 make_uint3( const int3& a ) { return make_uint3( uint32_t( a.x ), uint32_t( a.y ), uint32_t( a.z ) ); }
...
inline uint4 make_uint4( const uint32_t a, const uint32_t b, const uint32_t c, const uint32_t d ) { uint4 u4; u4.x = a, u4.y = b, u4.z = c, u4.w = d; return u4; }
inline uint4 make_uint4( const uint32_t s ) { return make_uint4( s, s, s, s ); }
inline uint4 make_uint4( const uint3& a ) { return make_uint4( a.x, a.y, a.z, 0 ); }
inline uint4 make_uint4( const uint3& a, const uint32_t w ) { return make_uint4( a.x, a.y, a.z, w ); }
inline uint4 make_uint4( const int4& a ) { return make_uint4( uint32_t( a.x ), uint32_t( a.y ), uint32_t( a.z ), uint32_t( a.w ) ); }
...
inline float2 operator+( const float2& a, uint32_t b ) { return make_float2( a.x + (float)b, a.y + (float)b ); }
...
inline void operator+=( float2& a, uint32_t b ) { a.x += (float)b;	a.y += (float)b; }
...
inline uint2 operator+( const uint2& a, uint32_t b ) { return make_uint2( a.x + b, a.y + b ); }
inline uint2 operator+( uint32_t b, const uint2& a ) { return make_uint2( a.x + b, a.y + b ); }
inline void operator+=( uint2& a, uint32_t b ) { a.x += b;	a.y += b; }
...
inline float3 operator+( const float3& a, uint32_t b ) { return make_float3( a.x + (float)b, a.y + (float)b, a.z + (float)b ); }
...
inline void operator+=( float3& a, uint32_t b ) { a.x += (float)b; a.y += (float)b; a.z += (float)b; }
...
inline uint3 operator+( const uint3& a, uint32_t b ) { return make_uint3( a.x + b, a.y + b, a.z + b ); }
inline void operator+=( uint3& a, uint32_t b ) { a.x += b;	a.y += b;	a.z += b; }
inline int3 operator+( int b, const int3& a ) { return make_int3( a.x + b, a.y + b, a.z + b ); }
inline uint3 operator+( uint32_t b, const uint3& a ) { return make_uint3( a.x + b, a.y + b, a.z + b ); }
...
inline float4 operator+( const float4& a, uint32_t b ) { return make_float4( a.x + (float)b, a.y + (float)b, a.z + (float)b, a.w + (float)b ); }
...
inline void operator+=( float4& a, uint32_t b ) { a.x += (float)b; a.y += (float)b; a.z += (float)b; a.w += (float)b; }
...
inline uint4 operator+( const uint4& a, uint32_t b ) { return make_uint4( a.x + b, a.y + b, a.z + b, a.w + b ); }
inline uint4 operator+( uint32_t b, const uint4& a ) { return make_uint4( a.x + b, a.y + b, a.z + b, a.w + b ); }
inline void operator+=( uint4& a, uint32_t b ) { a.x += b;	a.y += b;	a.z += b;	a.w += b; }
...
inline void operator-=( uint2& a, const uint2& b ) { a.x -= b.x;	a.y -= b.y; }
inline uint2 operator-( const uint2& a, uint32_t b ) { return make_uint2( a.x - b, a.y - b ); }
inline uint2 operator-( uint32_t b, const uint2& a ) { return make_uint2( b - a.x, b - a.y ); }
inline void operator-=( uint2& a, uint32_t b ) { a.x -= b;	a.y -= b; }
inline float3 operator-( const float3& a, const float3& b ) { return make_float3( a.x - b.x, a.y - b.y, a.z - b.z ); }
inline float3 operator-( const float3& a, const int3& b ) { return make_float3( a.x - (float)b.x, a.y - (float)b.y, a.z - (float)b.z ); }
inline float3 operator-( const float3& a, const uint3& b ) { return make_float3( a.x - (float)b.x, a.y - (float)b.y, a.z - (float)b.z ); }
...
inline void operator-=( uint3& a, const uint3& b ) { a.x -= b.x;	a.y -= b.y;	a.z -= b.z; }
inline uint3 operator-( const uint3& a, uint32_t b ) { return make_uint3( a.x - b, a.y - b, a.z - b ); }
inline uint3 operator-( uint32_t b, const uint3& a ) { return make_uint3( b - a.x, b - a.y, b - a.z ); }
inline void operator-=( uint3& a, uint32_t b ) { a.x -= b;	a.y -= b;	a.z -= b; }
inline float4 operator-( const float4& a, const float4& b ) { return make_float4( a.x - b.x, a.y - b.y, a.z - b.z, a.w - b.w ); }
inline float4 operator-( const float4& a, const int4& b ) { return make_float4( a.x - (float)b.x, a.y - (float)b.y, a.z - (float)b.z, a.w - (float)b.w ); }
inline float4 operator-( const float4& a, const uint4& b ) { return make_float4( a.x - (float)b.x, a.y - (float)b.y, a.z - (float)b.z, a.w - (float)b.w ); }
...
inline void operator-=( uint4& a, const uint4& b ) { a.x -= b.x;	a.y -= b.y;	a.z -= b.z;	a.w -= b.w; }
inline uint4 operator-( const uint4& a, uint32_t b ) { return make_uint4( a.x - b, a.y - b, a.z - b, a.w - b ); }
inline uint4 operator-( uint32_t b, const uint4& a ) { return make_uint4( b - a.x, b - a.y, b - a.z, b - a.w ); }
inline void operator-=( uint4& a, uint32_t b ) { a.x -= b;	a.y -= b;	a.z -= b;	a.w -= b; }
...
inline uint32_t clamp( uint32_t f, uint32_t a, uint32_t b ) { return max( a, min( f, b ) ); }
...
inline uint2 clamp( const uint2& v, uint32_t a, uint32_t b ) { return make_uint2( clamp( v.x, a, b ), clamp( v.y, a, b ) ); }
inline uint2 clamp( const uint2& v, const uint2& a, const uint2& b ) { return make_uint2( clamp( v.x, a.x, b.x ), clamp( v.y, a.y, b.y ) ); }
inline uint3 clamp( const uint3& v, uint32_t a, uint32_t b ) { return make_uint3( clamp( v.x, a, b ), clamp( v.y, a, b ), clamp( v.z, a, b ) ); }
...
inline uint4 clamp( const uint4& v, uint32_t a, uint32_t b ) { return make_uint4( clamp( v.x, a, b ), clamp( v.y, a, b ), clamp( v.z, a, b ), clamp( v.w, a, b ) ); }
...
inline uint32_t dot( const uint2& a, const uint2& b ) { return a.x * b.x + a.y * b.y; }
inline uint32_t dot( const uint3& a, const uint3& b ) { return a.x * b.x + a.y * b.y + a.z * b.z; }
inline uint32_t dot( const uint4& a, const uint4& b ) { return a.x * b.x + a.y * b.y + a.z * b.z + a.w * b.w; }
...
inline uint32_t dominantAxis( const float2& v ) { float x = fabs( v.x ), y = fabs( v.y ); return x > y ? 0 : 1; } // for coherent grid traversal
inline uint32_t dominantAxis( const float3& v ) { float x = fabs( v.x ), y = fabs( v.y ), z = fabs( v.z ); float m = max( max( x, y ), z ); return m == x ? 0 : (m == y ? 1 : 2); }
...
inline float3 diffusereflection( const float3 N, uint32_t& seed )
{
	float3 R;
	do
	{
...
inline float3 cosineweighteddiffusereflection( const float3 N, uint32_t& seed )
{
...
#pragma warning ( pop )
	...
	__inline float Center( uint32_t axis ) const { return (bmin[axis] + bmax[axis]) * 0.5f; }
};
